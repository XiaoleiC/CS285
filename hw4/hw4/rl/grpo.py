    ...
    def update(
        ...
        for _ in range(cfg.ppo_epochs):
            for mb in iter_minibatches(
                ...
                ratio = log_ratio.exp()
                adv_broadcasted = adv.unsqueeze(1)
                unclipped = ratio * adv_broadcasted
                clipped = ratio.clamp(1.0 - cfg.clip_eps, 1.0 + cfg.clip_eps) * adv_broadcasted
                ...
                clipfrac = ((ratio > (1.0 + cfg.clip_eps)) | (ratio < (1.0 - cfg.clip_eps))).float() * mask
